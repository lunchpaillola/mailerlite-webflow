...
const DeleteIcon = () => {
  return (
    <div className="relative group">
      ...
      <span className="tooltiptext bg-gray-700 text-white text-xs rounded p-1 absolute z-10 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out -mt-10">
        Delete
      </span>
    </div>
  );
